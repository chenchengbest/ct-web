...
<head>
	...
	<link href="${ctx}/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
	<link href="${ctx}/css/daterangepicker.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/css/fullcalendar.css" rel="stylesheet" type="text/css"/>
	<link href="${ctx}/css/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>
	<link href="${ctx}/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
	...
	<div class="navbar-inner">
		<div class="container-fluid">
			...
			<a class="brand" href="index.html">
				<img src="${ctx}/image/logo.png" alt="logo"/>
			</a>
			<!-- END LOGO -->
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li>
							<a href="inbox.html?a=view">
								<span class="photo"><img src="${ctx}/image/avatar2.jpg" alt="" /></span>
								<span class="subject">
						...
						<div class="portlet solid bordered light-grey">
							...
							<div class="portlet-body">
								<div id="site_statistics_loading">
									<img src="${ctx}/image/loading.gif" alt="loading" />
								</div>
											...
											<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
												<div class="row-fluid">
													<div class="span6 user-info">
														<img alt="" src="${ctx}/image/avatar.png" />
														<div class="details">
															<div>
						...
						<div class="portlet">
							...
							<div class="portlet-body" id="chats">
								<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
									<ul class="chats">
										<li class="in">
											<img class="avatar" alt="" src="${ctx}/image/avatar1.jpg" />
											<div class="message">
												<span class="arrow"></span>
										...
										<li class="out">
											<img class="avatar" alt="" src="${ctx}/image/avatar2.jpg" />
											<div class="message">
												<span class="arrow"></span>
										...
										<li class="out">
											<img class="avatar" alt="" src="${ctx}/image/avatar3.jpg" />
											<div class="message">
												<span class="arrow"></span>
...
<script src="${ctx}/js/jquery.vmap.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery.vmap.russia.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery.vmap.world.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery.vmap.europe.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery.vmap.germany.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery.vmap.usa.js" type="text/javascript"></script>
...
<script src="${ctx}/js/jquery.gritter.js" type="text/javascript"></script>
<script src="${ctx}/js/fullcalendar.min.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery.easy-pie-chart.js" type="text/javascript"></script>
